...
exports.postUploadGame = (req, res, next) => {
    ...
    blobStream.on("finish", () => {
        ...
        const gameHTML = '<iframe src="https://itch.io/embed/566214" height="167" width="552" frameborder="0"><a href="https://hby.itch.io/last-train-home">Last Train Home by hby</a></iframe>'
        Games.create({
            title: title,
            category: category,
